...
public class CommuneConfig {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CommuneConfig.class);
    ...
    @Autowired
    public CommuneConfig(@Value("${service.commune.scheme}") String scheme,
            @Value("${service.commune.endpoint}") String endpoint,
            @Value("${service.commune.process}") String process) {
